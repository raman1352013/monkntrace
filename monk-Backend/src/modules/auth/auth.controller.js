...
class AuthController {
  ...
  registerVendor = asyncHandler(async (req, res) => {
    ...
    const { companyName, contactEmail, password, contactFirstName, contactLastName, phone, city } = req.body;
    ...
    return sendSuccess(res, 201, 'Vendor registered successfully! You can now log in.', {
