    ...
    <header className="h-16 bg-surface border-b border-wireframe-border flex items-center justify-between px-gutter sticky top-0 z-20">
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search products, vendors, LCA projects…"
        ...
        <button 
          ...
          className="p-2 ml-1 rounded hover:bg-red-50 text-red-600 transition-colors flex items-center justify-center"
          title="Logout"
        >
